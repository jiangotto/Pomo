...
module fb_hpram #(
	...
	output wire vin_fifo_full,
	output wire vout_fifo_empty
);
...
//		.I_rd_halt         (1'd0), //input [0:0] I_rd_halt
		...
		.O_vin0_fifo_full  (vin_fifo_full), //output O_vin0_fifo_full
		...
		.O_vout0_fifo_empty(vout_fifo_empty), //output O_vout0_fifo_empty
